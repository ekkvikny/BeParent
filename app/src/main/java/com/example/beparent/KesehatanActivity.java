...
public class KesehatanActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private static final String TAG = "KesehatanActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kesehatan);
        setTitle("Kesehatan Anak");
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(KesehatanActivity.this, android.R.layout.simple_spinner_item, status );
        ...
        reference.child("konten")
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        adapter = new KontenViewAdapter(dataKonten, com.example.beparent.KesehatanActivity.this);
    ...
    private void MyRecyclerView(){
        ...
        LinearLayoutManager  layoutManager1 = new LinearLayoutManager(com.example.beparent.KesehatanActivity.this);
