...
public class RawatActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private static final String TAG = "RawatActivity";
        ...
        reference.child("konten")
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        adapter = new KontenViewAdapter(dataKonten, com.example.beparent.RawatActivity.this);
    ...
    private void MyRecyclerView(){
        ...
        LinearLayoutManager  layoutManager1 = new LinearLayoutManager(com.example.beparent.RawatActivity.this);
