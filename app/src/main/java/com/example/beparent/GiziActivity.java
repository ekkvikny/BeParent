...
public class GiziActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(GiziActivity.this, android.R.layout.simple_spinner_item, status );
        ...
        reference.child("konten")
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        adapter = new KontenViewAdapter(dataKonten, com.example.beparent.GiziActivity.this);
    ...
    private void MyRecyclerView(){
        ...
        LinearLayoutManager  layoutManager1 = new LinearLayoutManager(com.example.beparent.GiziActivity.this);
